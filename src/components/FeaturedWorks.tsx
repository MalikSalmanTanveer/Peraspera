    ...
    >
      ...
      <div
        style={{
          ...
          width: "80%",
          height: "60%",
          background: "radial-gradient(ellipse at center, rgba(255, 107, 53, 0.03), transparent 70%)",
          pointerEvents: "none",
          zIndex: 0,
        }}
      />
            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  padding: "24px",
                  boxShadow: isHovered
                    ? "0 30px 60px rgba(0, 0, 0, 0.8), 0 0 0 1px rgba(255, 107, 53, 0.25)"
                ...
                >
                  <div style={{ display: "flex", gap: "2px" }}>
                    {[...Array(5)].map((_, i) => (
                      <span
                        key={i}
                        style={{ color: "#FF6B35", fontSize: "1rem" }}
                      >
                        ★
                      </span>
                    ))}
