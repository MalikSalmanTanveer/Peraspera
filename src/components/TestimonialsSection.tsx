      ...
      <div className="container">
        ...
        <div
          style={{
            ...
            boxShadow: "0 30px 80px rgba(0, 0, 0, 0.7), inset 0 0 40px rgba(255, 107, 53, 0.02)",
          ...
          >
            ...
            <div style={{ display: "flex", gap: "16px" }}>
              <button
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = "#FF804D";
                  e.currentTarget.style.transform = "scale(1.05)";
                  e.currentTarget.style.boxShadow = "0 12px 30px rgba(255, 107, 53, 0.45)";
                }}
                onMouseLeave={(e) => {
                  ...
                  >
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                      ...
                      <div>
                        ...
                        >
                          {review.role} <span style={{ color: "#FF6B35" }}>{review.company}</span>
                        </p>
                      </div>
                    </div>
                  </motion.div>
