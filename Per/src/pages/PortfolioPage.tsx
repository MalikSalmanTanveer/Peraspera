          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
            {filteredWorks.map((work, index) => (
              <Reveal key={work.id} delay={index * 0.04}>
                <article className="group flex h-full flex-col overflow-hidden rounded-8xl border border-overlay-white-12 bg-white transition-all duration-card hover:-translate-y-1 hover:shadow-[0_24px_80px_rgba(0,0,0,0.28)]">
